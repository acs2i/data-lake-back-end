...
router.put(COLLECTION + "/:id", authorizationMiddlewear, async ( req: Request, res: Response) => {
    try {
        ...
        const response: UpdateWriteOpResult = await CollectionModel.updateOne({ _id}, {$set: object})
